function Get-OrganizationMicrosoftFormsSettings
{
    <#
    .SYNOPSIS
    ...
    PROCESS
    {
        ...
        {
            # Throw execption.
            Write-Log -Message ("Something went wrong getting organization Microsoft Form settings, execption is '{0}'" -f $_) -Level 'Error';
        }
    }
    END
    {
